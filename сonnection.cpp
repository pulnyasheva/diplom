...
namespace postgres
{
    ...
    void сonnection::try_refresh_connection()
    {
        ...
        {
            current_logger->log(log_level::DEBUG, fmt::format("Unable to update connection: {}", e.what()));
        }
    }
    ...
    void сonnection::refresh_connection()
    {
        try {
            ...
            current_logger->log(log_level::DEBUG, fmt::format("New connection {}", connection_dsn));
        } catch (const std::exception& e) {
            current_logger->log(log_level::ERROR, fmt::format("Connection update failed: {}", e.what()));
            throw;
        }
    }
